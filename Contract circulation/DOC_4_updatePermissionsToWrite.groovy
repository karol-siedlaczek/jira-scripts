...
log.warn(sendPostRequest("/rest/scriptrunner/latest/custom/updatePermissionsOneDriveFiles?issueKey=${issue.key}&permission=write&usersToChange=${usersToChange.join(',')}"))
